        ...
        for (var i = 0; i < Game.player.data.party.length; i++) {
            ...
            for (var lv = actorIncreaseExpRes.fromLv; lv <= actorIncreaseExpRes.toLv; lv++) {
                ...
                new SyncTask(singleActorTask, function (singleActorTask, actorIndex, lv, thisLvStartExp, thisLvEndExp, thisLvNeedExp) {
                    ...
                    var actorUI = _this.actorList.getItemUI(actorIndex);
            ...
            new SyncTask(this.getExpAnimationTask, function (i) {
                ...
                if (actorIncreaseExpRes) {
                    ...
                    if (learnSkills.length != 0) {
                        ...
                        _this.learnSkillActorFace.image = actor.face;
                        _this.learnSkillText.text = "" + WorldData.word_learnSkill;
                        var arr = [];
                        for (var i_1 = 0; i_1 < learnSkills.length; i_1++) {
                            var learnSkill = learnSkills[i_1];
                            var d = new ListItem_1030;
                            d.data = learnSkill;
                            d.icon = learnSkill.icon;
                            arr.push(d);
                        }
                        _this.learnSkillList.items = arr;
                        setTimeout(function () {
                            _this.skillBlock.visible = false;
                            setTimeout(function () {
                                SyncTask.taskOver(_this.getExpAnimationTask);
                            }, 200);
                        }, 1500);
