...
var GUI_Battle = (function (_super) {
    ...
    function GUI_Battle() {
        ...
        _this._selectedPlayerBattlerIndex = -1;
        _this.battleSceneCaches = [];
        _this.background.image = "";
        _this.actorInfoList.on(UIList.ITEM_CREATE, _this, _this.onCreateActorPanelItem);
        _this.actorInfoList.mouseEnabled = true;
        return _this;
    }
    ...
    GUI_Battle.prototype.createBattleScene = function (onFin, enemyParty) {
        ...
        var onComplete = function () {
            _this.battlerRoot.addChild(_this.currentBattleScene.displayObject);
            _this.currentBattleScene.mapSupportPause = false;
            _this.currentBattleScene.startRender();
            onFin();
        };
        if (enemyParty.battlerBgType == 0) {
            ...
            if (!this.battleSceneCaches[enemyParty.battleScene]) {
                ClientScene.createScene(enemyParty.battleScene, null, Callback.New(function (scene) {
                    _this.currentBattleScene = _this.battleSceneCaches[enemyParty.battleScene] = scene;
                    _this.battlerRoot.addChild(_this.currentBattleScene.displayObject);
    ...
    GUI_Battle.prototype.refreshActorPanel = function (index, isFirstRefresh) {
        ...
        var ui = this.actorInfoList.getItemUI(index);
        if (ui && actorDS) {
