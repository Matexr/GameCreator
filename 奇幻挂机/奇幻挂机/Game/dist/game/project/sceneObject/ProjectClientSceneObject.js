...
var ProjectClientSceneObject = (function (_super) {
    ...
    function ProjectClientSceneObject(soData, scene) {
        ...
        if (GameGate.gateState >= GameGate.STATE_3_IN_SCENE_COMPLETE) {
            ...
            var initCB_1 = Callback.New(function () {
                if (GameGate.gateState == GameGate.STATE_3_IN_SCENE_COMPLETE) {
                    _this.init();
                    EventUtils.removeEventListener(GameGate, GameGate.EVENT_IN_SCENE_STATE_CHANGE, initCB_1);
                }
            }, _this);
            EventUtils.addEventListener(GameGate, GameGate.EVENT_IN_SCENE_STATE_CHANGE, initCB_1);
        }
        return _this;
    }
    ...
    ProjectClientSceneObject.prototype.jumpTo = function (x, y, costFrame) {
        ...
        os.add_ENTERFRAME(function () {
            ...
            if (_this.supportPause && Game.pause)
                return;
